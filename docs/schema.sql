...
-- ============================================================================
--  MIGRATION 0017 (20260906120000_stock_events.sql, applied)
--  86-list from Toast Stock: menu_item_stock_events (events, not snapshots),
--  menu_item_stock_latest, ingredient_stockouts ("86'd since …" on verify),
--  daily_position.stockout_minutes. Full text below.
-- ============================================================================
...
-- ============================================================================
--  MIGRATION 0018 (20260906130000_labor.sql, applied)
--  labor_entries (Toast time entries, employee guid + job title only),
--  daily_labor and daily_cost_summary (net sales, pour/food cost, labor cost
--  and both as % of net sales). Full text below.
-- ============================================================================
